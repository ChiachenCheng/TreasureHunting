...
def test_register(client: FlaskClient):
    response = client.get("/%s/register" % (username))
    ...
    response = client.get("/%s/register" % (username2))
    json = response.get_json()
    print(json)
    tlist = json["status"].split(' ')
    l = len(tlist)
...
def test_wrong_1(client: FlaskClient):
    ...
    response = client.get("/%s/treasures" % (username3))
    json = response.get_json()
    print(json)
    tlist = json.split(' ')
    assert tlist[0] == 'ERROR'
...
def test_wrong_2(client: FlaskClient):
    ...
    response = client.get("/%s/rename/%s/%s" % (username, treasurename, 'price'))
    json = response.get_json()
    print(json)
    tlist = json["status"].split(' ')
    assert tlist[0] == 'Treasure'

    response = client.get("/%s/drop/%s" % (username, treasurename))
    json = response.get_json()
    print(json)
    tlist = json["status"].split(' ')
    assert tlist[0] == 'Treasure'
...
def test_wrong_3(client: FlaskClient):
    ...
    response = client.get("/%s/rename/%s/%s" % (username, treasurename3, treasurename))
    json = response.get_json()
    print(json)
    tlist = json["status"].split(' ')
    assert tlist[0] == 'ERROR'
